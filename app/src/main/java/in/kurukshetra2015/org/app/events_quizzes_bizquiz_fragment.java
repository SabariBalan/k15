...
public class events_quizzes_bizquiz_fragment extends Fragment {


    public static final String TAG = events_quizzes_bizquiz_fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;

    public static events_quizzes_bizquiz_fragment newInstance()
    {
        return new events_quizzes_bizquiz_fragment();
    }
        ...
        public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
        {
            switch (getArguments().getInt("section_number"))
            {
                default:
                    return null;
                case 1:
                    return paramLayoutInflater.inflate(R.layout.events_quizzes_tab_bq_intro, paramViewGroup, false);
                case 2:

                    return paramLayoutInflater.inflate(R.layout.events_quizzes_tab_bq_rules, paramViewGroup, false);
                case 3:

                    return paramLayoutInflater.inflate(R.layout.events_quizzes_tab_bq_contacts, paramViewGroup, false);
            }}
