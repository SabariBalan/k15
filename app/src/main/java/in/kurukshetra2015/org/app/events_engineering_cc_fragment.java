...
public class events_engineering_cc_fragment extends Fragment {


    public static final String TAG = events_engineering_cc_fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;

    public static events_engineering_cc_fragment newInstance()
    {
        return new events_engineering_cc_fragment();
    }
        ...
        public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
        {
            switch (getArguments().getInt("section_number"))
            {
                default:
                    return null;
                case 1:
                    return paramLayoutInflater.inflate(R.layout.events_engineering_tab_cc_intro, paramViewGroup, false);
                case 2:
                    return paramLayoutInflater.inflate(R.layout.events_engineering_tab_cc_format, paramViewGroup, false);
                case 3:

                    return paramLayoutInflater.inflate(R.layout.events_engineering_tab_cc_rules, paramViewGroup, false);
                case 4:

                    return paramLayoutInflater.inflate(R.layout.events_engineering_tab_cc_contacts, paramViewGroup, false);
            }}
