...
public class events_management_mm_fragment extends Fragment {


    public static final String TAG = events_management_mm_fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;

    public static events_management_mm_fragment newInstance()
    {
        return new events_management_mm_fragment();
    }
        ...
        public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
        {
            switch (getArguments().getInt("section_number"))
            {
                default:
                    return null;
                case 1:
                    return paramLayoutInflater.inflate(R.layout.events_management_tab_mm_intro, paramViewGroup, false);
                case 2:
                    return paramLayoutInflater.inflate(R.layout.events_management_tab_mm_format, paramViewGroup, false);
                case 3:

                    return paramLayoutInflater.inflate(R.layout.events_management_tab_mm_rules, paramViewGroup, false);
                case 4:

                    return paramLayoutInflater.inflate(R.layout.events_management_tab_mm_contacts, paramViewGroup, false);
            }}
