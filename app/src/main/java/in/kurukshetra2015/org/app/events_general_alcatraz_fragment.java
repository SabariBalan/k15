...
public class events_general_alcatraz_fragment extends Fragment {


    public static final String TAG = events_general_alcatraz_fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;

    public static events_general_alcatraz_fragment newInstance()
    {
        return new events_general_alcatraz_fragment();
    }
        ...
        public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
        {
            switch (getArguments().getInt("section_number"))
            {
                default:
                    return null;
                case 1:
                    return paramLayoutInflater.inflate(R.layout.events_general_tab_alcatraz_intro, paramViewGroup, false);
                case 2:
                    return paramLayoutInflater.inflate(R.layout.events_general_tab_alcatraz_format, paramViewGroup, false);
                case 3:

                    return paramLayoutInflater.inflate(R.layout.events_general_tab_alcatraz_rules, paramViewGroup, false);
                case 4:

                    return paramLayoutInflater.inflate(R.layout.events_general_tab_alcatraz_contacts, paramViewGroup, false);
            }}
