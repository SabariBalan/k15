...
public class events_online_ros_fragment extends Fragment {


    public static final String TAG = events_online_ros_fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;

    public static events_online_ros_fragment newInstance()
    {
        return new events_online_ros_fragment();
    }
        ...
        public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
        {
            switch (getArguments().getInt("section_number"))
            {
                default:
                    return null;
                case 1:
                    return paramLayoutInflater.inflate(R.layout.events_online_tab_ros_intro, paramViewGroup, false);
                 case 2:

                    return paramLayoutInflater.inflate(R.layout.events_online_tab_ros_rules, paramViewGroup, false);
                case 3:

                    return paramLayoutInflater.inflate(R.layout.events_online_tab_ros_contacts, paramViewGroup, false);
            }}
