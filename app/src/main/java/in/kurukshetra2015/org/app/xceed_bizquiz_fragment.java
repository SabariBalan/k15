...
public class xceed_bizquiz_fragment extends Fragment {


    public static final String TAG = xceed_bizquiz_fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;

    public static xceed_bizquiz_fragment newInstance()
    {
        return new xceed_bizquiz_fragment();
    }
        ...
        public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
        {
            switch (getArguments().getInt("section_number"))
            {
                default:
                    return null;
                case 1:
                    return paramLayoutInflater.inflate(R.layout.xceed_bizquiz_tab_intro, paramViewGroup, false);
               case 2:

                    return paramLayoutInflater.inflate(R.layout.xceed_bizquiz_tab_rules, paramViewGroup, false);
                case 3:

                    return paramLayoutInflater.inflate(R.layout.xceed_bizquiz_tab_contacts, paramViewGroup, false);
            }}
