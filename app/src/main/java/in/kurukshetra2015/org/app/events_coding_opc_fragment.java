...
public class events_coding_opc_fragment extends Fragment {


    public static final String TAG = events_coding_opc_fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;

    public static events_coding_opc_fragment newInstance()
    {
        return new events_coding_opc_fragment();
    }
        ...
        public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
        {
            switch (getArguments().getInt("section_number"))
            {
                default:
                    return null;
                case 1:
                    return paramLayoutInflater.inflate(R.layout.events_coding_tab_opc_intro, paramViewGroup, false);
                case 2:
                    return paramLayoutInflater.inflate(R.layout.events_coding_tab_opc_format, paramViewGroup, false);
                case 3:

                    return paramLayoutInflater.inflate(R.layout.events_coding_tab_opc_rules, paramViewGroup, false);
                case 4:

                    return paramLayoutInflater.inflate(R.layout.events_coding_tab_opc_contacts, paramViewGroup, false);
            }}
