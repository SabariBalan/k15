 ...
 */
public class events_coding_fragment extends Fragment {


    public static final String TAG = events_coding_fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;

    public static events_coding_fragment newInstance()
    {
        return new events_coding_fragment();
    }
