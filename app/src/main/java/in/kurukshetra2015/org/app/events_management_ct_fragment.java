...
public class events_management_ct_fragment extends Fragment {


    public static final String TAG = events_management_ct_fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;

    public static events_management_ct_fragment newInstance()
    {
        return new events_management_ct_fragment();
    }
        ...
        public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
        {
            switch (getArguments().getInt("section_number"))
            {
                default:
                    return null;
                case 1:
                    return paramLayoutInflater.inflate(R.layout.events_management_tab_ct_intro, paramViewGroup, false);
                case 2:
                    return paramLayoutInflater.inflate(R.layout.events_management_tab_ct_format, paramViewGroup, false);
                case 3:

                    return paramLayoutInflater.inflate(R.layout.events_management_tab_ct_rules, paramViewGroup, false);
                case 4:

                    return paramLayoutInflater.inflate(R.layout.events_management_tab_ct_contacts, paramViewGroup, false);
            }}
