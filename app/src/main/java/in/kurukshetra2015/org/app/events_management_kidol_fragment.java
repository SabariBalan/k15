...
public class events_management_kidol_fragment extends Fragment {


    public static final String TAG = events_management_kidol_fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;

    public static events_management_kidol_fragment newInstance()
    {
        return new events_management_kidol_fragment();
    }
        ...
        public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
        {
            switch (getArguments().getInt("section_number"))
            {
                default:
                    return null;
                case 1:
                    return paramLayoutInflater.inflate(R.layout.events_management_tab_kidol_intro, paramViewGroup, false);
                case 2:
                    return paramLayoutInflater.inflate(R.layout.events_management_tab_kidol_format, paramViewGroup, false);
                case 3:

                    return paramLayoutInflater.inflate(R.layout.events_management_tab_kidol_rules, paramViewGroup, false);
                case 4:

                    return paramLayoutInflater.inflate(R.layout.events_management_tab_kidol_contacts, paramViewGroup, false);
            }}
