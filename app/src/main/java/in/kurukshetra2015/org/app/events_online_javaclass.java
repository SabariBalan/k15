...
public class events_online_javaclass extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomList adapter = new CustomList(events_online_javaclass.this, web, imageId);
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            ...
            rowView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent contentIntent=new Intent(getContext(),events_online_content.class);
