...
public class xceed_kovai_javaclass extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Coimbatore");
        ...
        CustomList adapter = new CustomList(xceed_kovai_javaclass.this, web, imageId);
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            ...
            rowView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent contentIntent=new Intent(getContext(),xceed_kovai_content.class);
