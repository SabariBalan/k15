...
public class xceed_xcode_fragment extends Fragment {


    public static final String TAG = xceed_xcode_fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;

    public static xceed_xcode_fragment newInstance()
    {
        return new xceed_xcode_fragment();
    }
        ...
        public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
        {
            switch (getArguments().getInt("section_number"))
            {
                default:
                    return null;
                case 1:
                    return paramLayoutInflater.inflate(R.layout.xceed_xcode_tab_intro, paramViewGroup, false);
               case 2:

                    return paramLayoutInflater.inflate(R.layout.xceed_xcode_tab_contacts, paramViewGroup, false);
            }}
        ...
        public CharSequence getPageTitle(int paramInt)
        {
            ...
            switch (paramInt)
            {
                default:
                    return null;
                case 0:
                    return "Result".toUpperCase(localLocale);
                case 1:
