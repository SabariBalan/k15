...
public class events_robotics_kom_fragment extends Fragment {


    public static final String TAG = events_robotics_kom_fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;

    public static events_robotics_kom_fragment newInstance()
    {
        return new events_robotics_kom_fragment();
    }
        ...
        public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
        {
            switch (getArguments().getInt("section_number"))
            {
                default:
                    return null;
                case 1:
                    return paramLayoutInflater.inflate(R.layout.events_robotics_tab_kom_intro, paramViewGroup, false);
                case 2:
                    return paramLayoutInflater.inflate(R.layout.events_robotics_tab_kom_format, paramViewGroup, false);
                case 3:

                    return paramLayoutInflater.inflate(R.layout.events_robotics_tab_kom_problem_statement, paramViewGroup, false);

                case 4:

                    return paramLayoutInflater.inflate(R.layout.events_robotics_tab_kom_contacts, paramViewGroup, false);
            }}
