...
public class xceed_kozhikode_bizquiz_fragment extends Fragment {


    public static final String TAG = xceed_kozhikode_bizquiz_fragment.class.getSimpleName();
    SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;

    public static xceed_kozhikode_bizquiz_fragment newInstance()
    {
        return new xceed_kozhikode_bizquiz_fragment();
    }
        ...
        public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
        {
            switch (getArguments().getInt("section_number"))
            {
                default:
                    return null;
                case 1:
                    return paramLayoutInflater.inflate(R.layout.xceed_kozhikode_bizquiz_tab_intro, paramViewGroup, false);
               case 2:

                    return paramLayoutInflater.inflate(R.layout.xceed_kozhikodu_bizquiz_tab_rules, paramViewGroup, false);
                case 3:

                    return paramLayoutInflater.inflate(R.layout.xceed_kozhicode_biz_tab_contacts, paramViewGroup, false);
        ...
        public CharSequence getPageTitle(int paramInt)
        {
            ...
            switch (paramInt)
            {
                default:
                    return null;
                case 0:
                    return "Intro".toUpperCase(localLocale);
                case 1:
