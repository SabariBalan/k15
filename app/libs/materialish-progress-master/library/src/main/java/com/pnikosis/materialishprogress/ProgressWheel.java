...
public class ProgressWheel extends View {
    ...
    public ProgressWheel(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs,
                in.pnikosis.materialishprogress.R.styleable.ProgressWheel));
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(in.pnikosis.materialishprogress.R.styleable.ProgressWheel_circleRadius, circleRadius);

        fillRadius = a.getBoolean(in.pnikosis.materialishprogress.R.styleable.ProgressWheel_fillRadius, false);

        barWidth = (int) a.getDimension(in.pnikosis.materialishprogress.R.styleable.ProgressWheel_barWidth, barWidth);

        rimWidth = (int) a.getDimension(in.pnikosis.materialishprogress.R.styleable.ProgressWheel_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(in.pnikosis.materialishprogress.R.styleable.ProgressWheel_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(in.pnikosis.materialishprogress.R.styleable.ProgressWheel_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(in.pnikosis.materialishprogress.R.styleable.ProgressWheel_barColor, barColor);

        rimColor = a.getColor(in.pnikosis.materialishprogress.R.styleable.ProgressWheel_rimColor, rimColor);

        linearProgress = a.getBoolean(in.pnikosis.materialishprogress.R.styleable.ProgressWheel_linearProgress, false);

        if (a.getBoolean(in.pnikosis.materialishprogress.R.styleable.ProgressWheel_progressIndeterminate, false)) {
            spin();
        }
